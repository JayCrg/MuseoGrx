...
onMounted(() => {
    document.title = 'Políticas | MuseoGRX';
    window.scrollTo({
        top: 0,
        behavior: "instant"
    });
...
<h2 class="resaltado"><strong>Políticas de <span>privacidad</span></strong></h2>
<p>El presente Política de Privacidad establece los términos en que MuseoGRX usa y protege la información que es
...
<p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
    ...
    cualquier momento.</p>
<p>MuseoGRX está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los
...
<p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
    ...
    menos de que usted así lo quiera y la proporcione directamente <a href="https://noticias-fcbarcelona.es/"
...
<p>MuseoGRX Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
</p>
